...
function Sidebar({ query, setQuery }) {
   ...
   return (
      <div className='w-fit h-fit mx-auto mb-3 p-5  bg-white border-2 border-dashed border-blue-500 rounded-2xl shadow-lg
      md:w-52 md:ml-7 md:m-2 dark:bg-zinc-800 dark:text-white dark:shadow-none'>
