   ...
   return (
      ...
      justify-end bg-white border-2 border-dashed border-[#e2e2e2] rounded-2xl shadow-lg'>
         <img
            src={image}
            alt={title}
            className='w-[200px] h-[200px] p-5 mb-5 bg-white' />
         <h3 className='text-primary text-lg font-semibold'>
            {shortenText(title)}</h3>
         <p className='text-[#666] text-sm font-semibold mt-2.5  mb-4' >
            {price} </p>
         <div className='w-full flex justify-between items-center'>
            ...
            <button className='bg-primary text-white  border-none text-2xl h-8 w-8 p-0.5 rounded-lg cursor-pointer'>
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
